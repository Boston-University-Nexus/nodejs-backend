...
def parseClassHubRelation():
    ...
    classRows = []
    with open("../result/finalCsv.csv") as finalCsv:
    ...
    with open("../result/classHubRelation.json", "w") as json_file:
